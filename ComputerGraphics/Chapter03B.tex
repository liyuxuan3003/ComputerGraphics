...
\begin{Figure}[栅格图像的建模]
    \includegraphics[scale=0.8]{Chapter03B_05.fig.pdf}
\end{Figure}
...
\begin{Figure}[伽马值对显示的影响]
    \includegraphics[scale=0.8]{Chapter03B_07a.fig.pdf}
\end{Figure}
...
\begin{Figure}[伽马值的测定方法]
    \includegraphics[scale=0.8]{Chapter03B_03.fig.pdf}
\end{Figure}

假如我们已知知道$\gamma$，为了消除其影响，可以在输出之前通过$a'=a^{1/\gamma}$进行矫正。

\begin{Figure}[灰度色阶的对比]
    \figuresub[校正前]{\includegraphics[scale=0.8]{Chapter03B_01.fig.pdf}}

    \figuresub[校正后]{\includegraphics[scale=0.8]{Chapter03B_02.fig.pdf}}    
\end{Figure}
