...
\begin{Figure}[最大值混合]
    \includegraphics[scale=0.8]{Chapter16A_03e.fig.pdf}
\end{Figure}

\begin{Figure}[最小值混合]
    \includegraphics[scale=0.8]{Chapter16A_03d.fig.pdf}
\end{Figure}
...
因此，如\cref{fig:Ricci混合}，当$n\in[1,\infty)$，Ricchi混合提供了从相加混合到并集混合的连续过渡。
\begin{Figure}[Ricci混合]
    \figuresub[$n=1$;Ricci n=1]{\includegraphics[scale=0.8]{Chapter16A_03a.fig.pdf}}    \\ \vspace{0.25cm}
    \figuresub[$n=2$;Ricci n=2]{\includegraphics[scale=0.8]{Chapter16A_03b.fig.pdf}}    \hspace{1cm}
    \figuresub[$n=4$;Ricci n=4]{\includegraphics[scale=0.8]{Chapter16A_03c.fig.pdf}}    
\end{Figure}
