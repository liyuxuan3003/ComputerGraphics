...
\begin{Figure}[贝塞尔曲线]
    \figuresub[二次贝塞尔曲线]{\includegraphics[scale=0.8]{Chapter15D_03.fig.pdf}}    
    \hspace{1cm}
    \figuresub[三次贝塞尔曲线]{\includegraphics[scale=0.8]{Chapter15D_02.fig.pdf}}    
\end{Figure}
...
\begin{Figure}[三次贝塞尔曲线的混合函数]
    \includegraphics[scale=0.8]{Chapter15B_01f.fig.pdf}
\end{Figure}
...
\begin{Figure}[贝塞尔曲线的混合函数]
    \includegraphics[scale=0.8]{Chapter15D_01c.fig.pdf}
\end{Figure}
...
\begin{Figure}[贝塞尔曲线的效果]
    \includegraphics[scale=0.8]{Chapter15D_07.fig.pdf}
\end{Figure}
...
\begin{Figure}[贝塞尔曲线的分段拼接]
    \includegraphics[scale=0.8]{Chapter15D_10.fig.pdf}
\end{Figure}
...
\begin{Figure}[贝塞尔曲线与“以直代曲”]
    \includegraphics[scale=0.8]{Chapter15D_06.fig.pdf}
\end{Figure}
...
\begin{Figure}[贝塞尔曲线的德卡斯特里奥算法图示]
    \figuresub[二次贝塞尔曲线;二次贝塞尔曲线DeC算法]{\includegraphics[scale=0.8]{Chapter15D_04.fig.pdf}}    \hspace{1cm}
    \figuresub[三次贝塞尔曲线;三次贝塞尔曲线DeC算法]{\includegraphics[scale=0.8]{Chapter15D_05.fig.pdf}}    
\end{Figure}
...
\cref{fig:基样条曲线的混合函数示例}展示了一次、二次、三次基样条曲线的混合函数。我们注意到，随着次数$d$的增加，相应基样条曲线的混合函数的峰值会越来越低，从$d=1$的$1.0$下降到$d=2,3$的$0.75,0.67$。

\begin{Figure}[基样条曲线的混合函数示例]
    \figuresub[一次基样条曲线]{\includegraphics[scale=0.8]{Chapter15D_09a.fig.pdf}}    \\ \vspace{0.1cm}
    \figuresub[二次基样条曲线]{\includegraphics[scale=0.8]{Chapter15D_09b.fig.pdf}}    \hspace*{-1.5cm}
    \figuresub[三次基样条曲线]{\includegraphics[scale=0.8]{Chapter15D_09c.fig.pdf}}    
\end{Figure}

\cref{fig:基样条曲线的混合函数}展示了$n=7$个控制点下$d=3$次基样条曲线的混合函数。和\cref{fig:基数三次样条曲线的混合函数}一致，这种情况下有$n+d+1$个节点，但只有中央$n-d+1$个节点是有效范围，首末$d$个节点在定义域外。
\begin{Figure}[基样条曲线的混合函数]
    \includegraphics[scale=0.8]{Chapter15D_01d.fig.pdf}
\end{Figure}

\cref{fig:基样条曲线的效果}展示了$d=3$次基样条曲线的实际效果
\begin{Figure}[基样条曲线的效果]
    \includegraphics[scale=0.8]{Chapter15D_08.fig.pdf}
\end{Figure}
