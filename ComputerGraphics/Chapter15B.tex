...
\cref{fig:一次曲线}展示了一条一次曲线，控制点$\vb{p}_0,\vb{p}_1$代表了其起点和终点。
\begin{Figure}[一次曲线]
    \includegraphics[scale=0.8]{Chapter15B_02.fig.pdf}
\end{Figure}
一次曲线的通式是
\begin{Equation}
...
\begin{Figure}[一次曲线的混合函数]
    \includegraphics[scale=0.8]{Chapter15B_01a.fig.pdf}
\end{Figure}

\subsection{二次曲线}
\cref{fig:二次曲线}展示了一条二次曲线，控制点$\vb{p}_0,\vb{p}_1$代表了其起点和终点。
\begin{Figure}[二次曲线]
    \includegraphics[scale=0.8]{Chapter15B_03.fig.pdf}
\end{Figure}
二次曲线的通式及其一阶导数为
\begin{Gather}
...
\begin{Figure}[二次曲线的混合函数]
    \includegraphics[scale=0.8]{Chapter15B_01b.fig.pdf}
\end{Figure}
